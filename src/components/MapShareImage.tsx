  ...
  return (
    <>
      <style>{`
        ...
        .ms-logo{font-size:32px;font-weight:800;color:rgba(255,255,255,0.25);letter-spacing:4px}
        .ms-sub{font-size:12px;color:rgba(255,255,255,0.2);letter-spacing:4px;margin-top:4px}
        .ms-hero{text-align:center;padding:20px 0}
        .ms-hero-type{font-size:76px;font-weight:800;color:#fff;letter-spacing:8px;text-shadow:0 0 32px rgba(168,85,247,0.65),0 0 64px rgba(168,85,247,0.25);line-height:1}
        .ms-hero-title{font-size:19px;font-weight:700;color:rgba(255,255,255,0.5);margin-top:12px}
